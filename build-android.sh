...
## ================================================================
## JXBarcode Android Build Environment Setup
## ================================================================
##
...
# Options
name="JXBarcode"
icon="assets/jxbarcode.png"

# Dynamic variable based on source code
id="io.fyne.jxbarcode"
...
## Production options 
tags="production,no_emoji,no_animations"
release="true"
...
apk_output="build/jxbarcode-$version-android-arm64.apk"

## Generate the AndroidManifest.xml file
cat > AndroidManifest.xml <<EOF
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    package="io.fyne.jxbarcode">
