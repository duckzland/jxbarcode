...
## ================================================================
## JXBarcode Windows Build Environment Setup
## ================================================================
##
...
cd static/windows/
output=$(go-winres simply --icon jxbarcode.ico --manifest gui --product-version "$version" --file-version "$version" --product-name "$app_name" 2>&1)
...
<Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
  ...
  <Product Id="$product_guid" Name="$app_name" Language="1033" Version="$version"
    ...
    <Property Id="ARPPRODUCTICON" Value="jxbarcode.ico" />
    ...
    <Icon Id="jxbarcode.ico" SourceFile="static/windows/jxbarcode.ico" />
